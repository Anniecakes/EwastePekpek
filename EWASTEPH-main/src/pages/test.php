                    ...
                    <form method="post" action="">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="image" name="image" class="form-control" placeholder="https://...">
                            </div>
                        </div>
                    ...
                    <tbody>
                        <?php while ($product = $products->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        $categories = [1 => 'Electronics', 2 => 'Components', 3 => 'Accessories'];
                                        echo $categories[$product['category']] ?? 'Unknown';
                                    ?>
                                </td>
                                <td class="action-buttons">
                                    ...
                                    <form method="post" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this product?');">
                                        ...
                                        <button type="submit" name="delete" class="btn btn-reject">
...
<?php elseif ($main_section == 'orders'): ?>
    ...
    <!-- Orders Table -->
    <?php if (isset($orders_data) && $orders_data->num_rows > 0): ?>
        <table>
            <thead>
                <tr>
                    <th>Order ID</th>
            ...
            <tbody>
                ...
                <td class="hide-sm">
                    ...
                    <?php endif; ?>
                        ...
                        <td><?php echo displayStatus($order['order_status']); ?></td>
                        <td class="action-buttons">
                            ...
                            <?php if ($order['order_status'] == ORDER_STATUS_PROCESSING): ?>
                                <form method="post" style="display: inline;">
                                    <input type="hidden" name="order_id" value="<?php echo $order['order_id']; ?>">
                            ...
                            <?php if ($order['order_status'] == ORDER_STATUS_SHIPPED): ?>
                                <form method="post" style="display: inline;">
                                    <input type="hidden" name="order_id" value="<?php echo $order['order_id']; ?>">
                            ...
                            <?php if ($order['order_status'] != ORDER_STATUS_CANCELLED && $order['order_status'] != ORDER_STATUS_DELIVERED): ?>
                                <form method="post" style="display: inline;">
                                    <input type="hidden" name="order_id" value="<?php echo $order['order_id']; ?>">
